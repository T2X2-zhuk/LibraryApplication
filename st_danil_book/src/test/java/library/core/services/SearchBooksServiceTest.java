...
public class SearchBooksServiceTest extends LibraryServiceValidationTest{
	...
	public void shouldReturnResponseWithErrorsWhenValidatorFails() {
		...
		errors.add(new ValidationError("ERROR_CODE_1", "Title must not be empty!"));
		errors.add(new ValidationError("ERROR_CODE_2", "Author must not be empty!"));

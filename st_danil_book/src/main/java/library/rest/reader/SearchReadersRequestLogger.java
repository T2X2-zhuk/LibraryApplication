...
@Component
 class SearchReadersRequestLogger {

    private static final Logger logger = LoggerFactory.getLogger(SearchReadersRequestLogger.class);

    void log(SearchReadersRequest
                     request) {

...
@Component
 class RemoveBookRequestLogger {

    private static final Logger logger = LoggerFactory.getLogger(RemoveBookRequestLogger.class);

    void log(RemoveBookRequest request) {

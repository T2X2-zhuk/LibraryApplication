...
@Component
 class RemoveBookResponseLogger {

 private static final Logger logger = LoggerFactory.getLogger(RemoveBookResponseLogger.class);

 void log(RemoveBookResponse request) {

...
@Component
 class DeleteReaderBookResponseLogger {

    private static final Logger logger = LoggerFactory.getLogger(DeleteReaderBookResponseLogger.class);

    void log(DeleteReaderBookResponse request) {

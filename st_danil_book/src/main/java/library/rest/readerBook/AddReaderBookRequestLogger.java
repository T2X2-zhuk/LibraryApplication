...
@Component
 class AddReaderBookRequestLogger {

    private static final Logger logger = LoggerFactory.getLogger(AddReaderBookRequestLogger.class);

    void log(AddReaderBookRequest request) {
